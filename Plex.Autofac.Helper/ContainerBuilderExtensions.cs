...
{
    public static ContainerBuilder RegisterAssemblyWithMetaData<TMetaData, TIService>(this ContainerBuilder containerBuilder) where TIService : class
    {
        ...
        foreach (var item in metaDatas)
        {
            ...
            containerBuilder.RegisterType(item).As<TIService>().WithMetadata("PortalPartMetadata", name);
        }
